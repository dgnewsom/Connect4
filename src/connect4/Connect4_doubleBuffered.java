...
public class Connect4_doubleBuffered extends Canvas implements MouseListener
{
	
	private static final long serialVersionUID = -4236878017634665880L;
	...
	static Ellipse2D circle1, circle2, circle3, circle4, circle5, circle6, circle7, circle8, circle9, circle10, circle11, circle12, circle13;
	...
	static Rectangle rect = new Rectangle(0, 0, 100, 50);
	static boolean firstTime = true;
	static String player1Name = "";
	static String player2Name = "";
	
	public Connect4_doubleBuffered()
	{
	...
	public void paint(Graphics g) {
		...
		if(hasWinner()) {
			...
			curColour = getColour(currentTurn);
			g2.setColor(curColour);
			g2.fillRect(10, 0, getWidth()-20, 100);
			...
			String winner;
			if(currentTurn == 0) {
				winner = String.format("%s WINS",player1Name);
				g2.drawString(winner, (win.getWidth()/2) - (winner.length()*24), 75);
			}
			else {
				winner = String.format("%s WINS",player2Name);
				g2.drawString(winner, (win.getWidth()/2) - (winner.length()*24), 75);
			}
	...
	static public void drawBoard() {
		...
		circle12 = new Ellipse2D.Double(50,13,80,80);
		circle13 = new Ellipse2D.Double(win.getWidth()-130,13,80,80);
	...
	public static void main( String[] args )
	{
		...
		win.setSize(1150,900);
		win.setLocation(400, 0);
		win.setDefaultCloseOperation( JFrame.EXIT_ON_CLOSE );
		win.add( new Connect4_doubleBuffered() );
		win.setVisible(true);
		win.setResizable(false);
		player1Name = JOptionPane.showInputDialog("Player 1 enter your name (Red)").toUpperCase();
		
		player2Name = JOptionPane.showInputDialog("Player 2 enter your name (Yellow)").toUpperCase();
	}
